...
//extern short igx,igy,igz;
//extern short iax,iay,iaz;
//extern short imx,imy,imz;
				  ...
				  //           tmp1 = q1 + ( q0*gx + q2*gz - q3*gy)*halfT;
					...
					////RUNGE_KUTTA 法解微分方程
					 ...
					 // normalise quaternion
					  ...
					  yaw  =  atan2(2 * q1 * q2 + 2 * q0 * q3, -2 * q1*q1 - 2 * q2* q2 + 1)* 57.3;
}
