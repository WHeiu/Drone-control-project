...
void MMPU9250_Init(void)
{
	...
	MPU9250_SPI_Write(MPU9250_SMPLRT_DIV, SMPLRT_DIV);     //设置采样率 Internal_Sample_Rate/(1 + 25)  内部采样率1K？？？
	LL_mDelay(1);
	//MPU9250 Set Full Scale Gyro Range
	//Fchoice_b[1:0] = [00] enable DLPF
	MPU9250_SPI_Write(MPU9250_GYRO_CONFIG, (MPU9250_FSR_2000DPS << 3));
	LL_mDelay(1);
...
//	else
  ...
  while(!(res == 0x00))
	...
	//单次测量   
	MPU9250_AK8963_SPI_Write(MPU9250_AK8963_I2C_ADDR,MPU9250_AK8963_CNTL, MPU9250_AK8963_SINGLE_MEASUREMENT);
	LL_mDelay(1);
//	MPU9250_AK8963_SPI_Read(MPU9250_AK8963_I2C_ADDR,MPU9250_AK8963_CNTL,&res);//测试MPU9250_AK8963_SPI_Read
//	LL_mDelay(1);
//	printff(USART3, "等待磁力计设置为单次测量模式\r\n",strlen("等待磁力计设置为单次测量模式\r\n"));
//	while(!(res != MPU9250_AK8963_SINGLE_MEASUREMENT))
//	{
//		MPU9250_AK8963_SPI_Write(MPU9250_AK8963_I2C_ADDR,MPU9250_AK8963_CNTL, MPU9250_AK8963_SINGLE_MEASUREMENT);
//		LL_mDelay(1);
//		MPU9250_AK8963_SPI_Read(MPU9250_AK8963_I2C_ADDR,MPU9250_AK8963_CNTL,&res);//测试MPU9250_AK8963_SPI_Read
//		LL_mDelay(1);
//	}
	printff(USART3, "磁力计设置为单次测量模式成功\r\n",strlen("磁力计设置为单次测量模式成功\r\n"));
