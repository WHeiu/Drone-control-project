...
//	  q00 = inv_q29_mult(quatt[0], quatt[0]);
//    q01 = inv_q29_mult(quatt[0], quatt[1]);
//    q02 = inv_q29_mult(quatt[0], quatt[2]);
//    q03 = inv_q29_mult(quatt[0], quatt[3]);
//    q11 = inv_q29_mult(quatt[1], quatt[1]);
//    q12 = inv_q29_mult(quatt[1], quatt[2]);
//    q13 = inv_q29_mult(quatt[1], quatt[3]);
//    q22 = inv_q29_mult(quatt[2], quatt[2]);
//    q23 = inv_q29_mult(quatt[2], quatt[3]);
//    q33 = inv_q29_mult(quatt[3], quatt[3]);
    /* X component of the Ybody axis in World frame */
    t1 = q12 - q03;
