...
void LCD_Show(void)
{
	...
	LCD_ShowString(20,50,200,16,16,"Test MS5611:");		

	LCD_ShowString(20,110,200,16,16,"T:");	
	LCD_ShowString(150,110,200,16,16,"'C");
	
	LCD_ShowString(20,190,200,16,16,"Pressure:");	
	LCD_ShowString(180,190,200,16,16,"mba");	
}


void LCD_MS5611_DataShow(void)
{
		unsigned char T[6],P[8];
	
		T[0] = TEMP/1000 + 0x30;
		T[1] = TEMP%1000/100 + 0x30;
		T[2] = '.';
		T[3] = TEMP%100/10 + 0x30;
		T[4] = TEMP%10 + 0x30;
		T[5] = '\0';
	
	//	LCD_ShowString(100,110,200,16,16, T);	
	
		P[0] = Pressure/100000 + 0x30;
		P[1] = Pressure%100000/10000 + 0x30;
		P[2] = Pressure%10000/1000 + 0x30;
		P[3] = Pressure%1000/100 + 0x30;
		P[4] = '.';
		P[5] = Pressure%100/10 + 0x30;
		P[6] = Pressure%10 + 0x30;
		P[7] = '\0';
