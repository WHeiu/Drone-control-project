...
void EC20Send_RecAccessMode(void)
{
		...
		Re_strx=strstr((const char*)UART4_ReceiveBuff,(const char*)"A1");
			if(Re_strx)
			{		
				printff(USART3, "A1 running!!!!!\r\n",strlen("A1 running!!!!!\r\n"));
				while(1);
				USART_CLR_RecvBuf();
      }
		Re_strx=strstr((const char*)UART4_ReceiveBuff,(const char*)"A0");
			if(Re_strx)
			{		
				printff(USART3, "A0 running!!!!!\r\n",strlen("A0 running!!!!!\r\n"));
				USART_CLR_RecvBuf();
      }
			Re_strx=strstr((const char*)UART4_ReceiveBuff,(const char*)"B1");
			if(Re_strx)
			{		
				printff(USART3, "B1 running!!!!!\r\n",strlen("B1 running!!!!!\r\n"));
				USART_CLR_RecvBuf();
      }
		Re_strx=strstr((const char*)UART4_ReceiveBuff,(const char*)"B0");
			if(Re_strx)
			{		
