...
/*******************Init GYRO and ACCEL******************************/	
	...
	MPU9250_Write_Reg(ACCEL_CONFIG, 0x01);//加速计自检、测量范围及高通滤波频率，典型值：0x18(不自检，2G)
