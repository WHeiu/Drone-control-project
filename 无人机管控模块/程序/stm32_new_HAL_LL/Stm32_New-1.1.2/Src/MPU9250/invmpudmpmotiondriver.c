 ...
 */
#if 1 //defined EMPL_TARGET_STM32F4
#include "mmpu9250.h"   
    ...
    unsigned long *timestamp, short *sensors, unsigned char *more)
{
    ...
    if (mpu_read_fifo_stream(dmp.packet_length, fifo_data, more))
		{
			printff(USART3, "mpu_read_fifo_stream ß∞‹!!!\r\n",strlen("mpu_read_fifo_stream ß∞‹!!!\r\n"));	 
        return -1;
		}
    ...
    if (dmp.feature_mask & (DMP_FEATURE_LP_QUAT | DMP_FEATURE_6X_LP_QUAT)) {
        ...
        if ((quat_mag_sq < QUAT_MAG_SQ_MIN) ||
            ...
            mpu_reset_fifo();
            sensors[0] = 0;
							printff(USART3, "(quat_mag_sq < QUAT_MAG_SQ_MIN) ||(quat_mag_sq > QUAT_MAG_SQ_MAX) ß∞‹!!!\r\n",strlen("(quat_mag_sq < QUAT_MAG_SQ_MIN) ||(quat_mag_sq > QUAT_MAG_SQ_MAX) ß∞‹!!!\r\n"));	 
            return -1;
        }
